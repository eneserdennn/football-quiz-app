  ...
  return (
    <SafeAreaView className="flex-1 bg-dark-green">
      ...
      <View className="relative flex-col items-center justify-center rounded-md">
        {playerClub !== "" ? (
          <View className="absolute flex items-center shadow-2xl justify-center border-2 border-light-gray bg-light-green rounded-full h-16 w-16 top-6 right-2">
            <Image
              source={{
                uri: playerClubImage,
              }}
          ...
          <View className="absolute flex items-center shadow-2xl justify-center bg-black rounded-full h-16 w-16 top-6 right-2">
        ...
        <View className="absolute flex items-center shadow-2xl justify-center bg-black rounded-full h-20 w-20 bottom-3 right-1">
        ...
        {playerCountry !== "" ? (
          <View className="absolute flex items-center shadow-2xl justify-center border-2 border-light-gray bg-light-green rounded-full h-16 w-16 bottom-6 left-2">
            <Image
              source={{
          ...
          <View className="absolute flex items-center shadow-2xl justify-center bg-black rounded-full h-16 w-16 bottom-6 left-2">
            <Text className="text-white text-[32px] font-bold">?</Text>
          </View>
        )}
        {playerPosition !== "" ? (
          <View className="absolute flex items-center shadow-2xl  justify-center border-2 border-light-gray bg-light-green rounded-full h-16 w-16 top-6 left-2">
            <Text className="text-white font-bold">{playerPosition}</Text>
          </View>
        ) : (
          <View className="absolute flex items-center shadow-2xl justify-center bg-black rounded-full h-16 w-16 top-6 left-2">
            <Text className="text-white text-[32px] font-bold">?</Text>
          </View>
        )}
